...
IF "%eclipsehome%"=="" (
 set eclipsehome=C:/wM103_Designer/Designer/eclipse/
)
...
IF "%java%"=="" (
  set java=C:\wM103_Designer\jvm\jvm\jre\bin\java.exe
)
...
IF "%buildfile%"=="" (
  set buildfile=C:\Users\99gu2142\git\PoCNatDevOps\GISSPoCNatDevOps\build.xml
)
